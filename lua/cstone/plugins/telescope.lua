...
highlight TelescopeSelection guibg=none guifg=#ebdbb2
]]

-- Ensure the customizations are reapplied after a colorscheme is loaded
vim.cmd [[
augroup TelescopeColors
  autocmd!
  autocmd ColorScheme * highlight TelescopeNormal guibg=none
  autocmd ColorScheme * highlight TelescopeSelection guibg=none guifg=#ebdbb2
augroup END
]]
